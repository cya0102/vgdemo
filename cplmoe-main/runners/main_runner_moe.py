"""
MoE-aware runner that extends MainRunner to handle auxiliary MoE losses.

Key difference from MainRunner:
- Integrates aux_loss (load balancing loss) from MoE output into training
"""
import collections
import logging
import os
...
class MoERunner:
    ...
    def _train_one_epoch(self, epoch, **kwargs):
        ...
        for bid, batch in enumerate(self.train_loader, 1):
            ...
            # Integrate MoE auxiliary loss (load balancing)
