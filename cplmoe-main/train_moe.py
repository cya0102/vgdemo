"""
Training script for CPL-MoE models.
Uses MoERunner which integrates auxiliary MoE losses into training.
"""
import argparse
import time
import os
...
def parse_args():
    ...
    parser.add_argument('--tag', default='cpl_moe2', type=str, help='experiment tag')
...
def main(kargs):
    ...
    import random
    import torch
    from runners.main_runner_moe import MoERunner
