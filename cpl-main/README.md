...
- Weakly Supervised Temporal Sentence Grounding with Gaussian-based Contrastive Proposal Learning, **CVPR 2022** ([paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Zheng_Weakly_Supervised_Temporal_Sentence_Grounding_With_Gaussian-Based_Contrastive_Proposal_Learning_CVPR_2022_paper.pdf), [code](#)).

- Weakly and Single-Frame Supervised Temporal Sentence Grounding With Gaussian-Based Contrastive Proposal Learning, **TPAMI 2025** ([paper](https://www.computer.org/csdl/journal/tp/5555/01/11301624/2cwBH2tytUY), [code](cpl+)).
...
Our paper was accepted by CVPR-2022. [[Paper](https://openaccess.thecvf.com/content/CVPR2022/papers/Zheng_Weakly_Supervised_Temporal_Sentence_Grounding_With_Gaussian-Based_Contrastive_Proposal_Learning_CVPR_2022_paper.pdf)] [[Project Page](https://minghangz.github.io/publication/cpl/)]
